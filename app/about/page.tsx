...
export default function AboutPage() {
  ...
  return (
    <main className='flex min-h-screen flex-col'>
      ...
      <section className='py-24 bg-linear-to-r from-brand-green/[0.02] to-brand-blue/[0.02]'>
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
            <div className='group bg-[#f8f7f4] p-8 rounded-2xl shadow-xs transition-all duration-300 hover:shadow-lg'>
      ...
      <section className='py-24 bg-linear-to-r from-brand-green/[0.02] to-brand-blue/[0.02]'>
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto bg-[#f8f7f4] p-8 rounded-2xl shadow-xs relative'>
